...
export default function Recipe(props) {
  ...
  const recipe = useSelector((state) => state.recipe.recipe);
	const noRecipeFound = useSelector((state) => !state.recipe.recipeQuerySuccessful);
	...
	return <p className="warning">Kein passendes Rezept gefunden! Bitte Filterkriterien ändern.</p>;
}
